...
var assert, chai, counts, data, dataset, expect, page, prof, state, test_graph, vehicles, _;
...
if (typeof require !== "undefined" && require !== null) {
  ...
  if (dataset == null) {
    throw "Dependency not met: dataset";
  }
  if (_ == null) {
...
describe('Dataset', function() {
  beforeEach(function() {
    ...
    return this.data = dataset(this.graph);
  });
  ...
  it('should now allow setting non-collection values directly to dataset', function() {
  ...
  return describe('dataset.cursor', function() {
    beforeEach(function() {
      return this.page = this.data.cursor('page');
    });
    afterEach(function() {
      return this.page.dispose();
    });
    return it('should be returned from dataset', function() {});
  });
});
